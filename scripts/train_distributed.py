...
def main():
    ...
    model_config = DRMTransformerConfig(
        ...
        distance_mode=config.get("distance_mode", "local"),
        quad_points=config.get("quad_points", config.get("n_quad", 0)),
        distance_chunk_size=config.get("distance_chunk_size", 0),
